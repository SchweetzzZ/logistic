...
export const auditFreightSchema = mysqlTable('audit_freight', {
  ...
  actualWeightKg: decimal('actual_weight_kg', {
    precision: 10,
    scale: 3,
  }).notNull(),
  volumetricWeightKg: decimal('volumetric_weight_kg', {
    precision: 10,
    scale: 3,
  }).notNull(),
  chargedWeightKg: decimal('charged_weight_kg', {
    precision: 10,
    scale: 3,
  }).notNull(),
  declaredValue: decimal('declared_value', {
    precision: 10,
    scale: 2,
  }).notNull(),
